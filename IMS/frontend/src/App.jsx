    ...
    <div className="min-h-screen bg-[#f9f6f0] font-sans text-stone-800">
      <nav className="bg-white border-b border-stone-200 sticky top-0 z-30 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center h-16">
          ...
          <Link to="/login" className="text-xs font-bold text-stone-500 hover:text-pink-600 transition uppercase tracking-wider bg-stone-100 hover:bg-pink-50 px-4 py-2 rounded-lg">
            Admin Login
          </Link>
        </div>
      </nav>
...
function AdminDashboard() {
  ...
  const fetchData = async (isBackgroundRefresh = false) => {
    ...
    try {
      ...
      if (!isBackgroundRefresh) {
        setErrorMessage('Could not connect to Django server. Make sure your backend is running.');
        setLoading(false);
      }
    }
  };
  ...
  // ==========================================
  // CALCULATIONS & BATCH TRACKER GROUPING
  // ==========================================
